...
config.General.requestName   = 'case2_2500'
...
config.Data.inputDataset = '/ZZZ-v1-2500/xulyu-crab_ZZZ-MA-2500-28028af67189b3de7224b79195bd0e1d/USER'
...
config.Data.outputDatasetTag = 'case2_2500'
