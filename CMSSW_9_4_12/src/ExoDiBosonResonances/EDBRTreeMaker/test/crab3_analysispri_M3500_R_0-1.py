...
config.General.requestName   = 'M3500_R0-1_off_pri'
...
config.Data.inputDataset = '/VVV-3000-R01_hpp/qili-crab_VVV_MiniAOD_v2-05265a4e675f881e1e171fd06785811b/USER'
...
config.Data.outputDatasetTag = 'M3500_R0-1_off_pri'
