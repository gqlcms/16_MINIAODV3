...
config.General.requestName   = 'case1_1500_off'
...
config.Data.inputDataset = '/WkkToWRadionToZZZ_M1500-R0-12-TuneCUEP8M1_13TeV-madgraph/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
...
#config.Data.outLFNDirBase = '/store/user/' + steam_dir + '/' + name + '/'
# This string is used to construct the output dataset name
config.Data.outputDatasetTag = 'case1_1500_off'
