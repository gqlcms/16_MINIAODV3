...
config.General.requestName   = 'MMASS_RRNUM_off'
...
config.Data.inputDataset = '/WkkToWRadionToZZZ_MMASS-RRNUM-TuneCUEP8M1_13TeV-madgraph/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
...
config.Data.outputDatasetTag = 'MMASS_RRNUM_off'
