...
config.General.requestName   = 'case2_1500'
...
config.Data.inputDataset = '/ZZZ-v1-1500/xulyu-crab_ZZZ-MA-1500-28028af67189b3de7224b79195bd0e1d/USER'
...
config.Data.outputDatasetTag = 'case2_1500'
