...
config.General.requestName   = 'case1_1500'
...
config.Data.inputDataset = '/ZZZ-v2-1500/xulyu-crab_ZZZ-MA-1500-5-28028af67189b3de7224b79195bd0e1d/USER'
...
config.Data.outputDatasetTag = 'case1_1500'
